...
// implemented by pon
public class SocketClientController implements ClientHandlerInterface, Runnable {


    public SocketClientController(String ipAddr, ObserverViewInterface observerView)  throws IOException {
