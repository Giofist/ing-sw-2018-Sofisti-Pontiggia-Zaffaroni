...
public class Client {
    ...
    public static void main(String IPdelServer) throws Exception {
        ...
        //tutto questo crea delle crepe nell'architettura he abbiamo individuato finora... voi che ne dite?
