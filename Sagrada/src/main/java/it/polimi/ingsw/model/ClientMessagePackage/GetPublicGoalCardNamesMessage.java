...
public class GetPublicGoalCardNamesMessage extends ClientMessage {

    public GetPublicGoalCardNamesMessage() { this.messagecodex = 44; }

    @Override
    public void performAction(ClientHandlerInterface clientHandler, SocketServerListener listener) {

        try {
            String answer = clientHandler.getPublicGoalCardnames(getClientName());
