...
public class GetPublicGoalCardIdsMessage extends ClientMessage {

    public GetPublicGoalCardIdsMessage() { this.messagecodex = 44; }

    @Override
    public void performAction(ClientHandlerInterface clientHandler, SocketServerListener listener) {

        try {
            String answer = clientHandler.getPublicGoalCardids(getClientName());
