...
public class GetToolCardsDescriptionsMessage extends ClientMessage {

    public GetToolCardsDescriptionsMessage() { this.messagecodex = 44; }

    @Override
    public void performAction(ClientHandlerInterface clientHandler, SocketServerListener listener) {

        try {
            String answer = clientHandler.getToolCardsDescriptions(getClientName());
