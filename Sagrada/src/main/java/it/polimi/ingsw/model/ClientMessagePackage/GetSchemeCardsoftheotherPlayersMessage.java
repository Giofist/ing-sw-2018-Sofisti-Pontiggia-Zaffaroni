...
public class GetSchemeCardsoftheotherPlayersMessage extends ClientMessage {

    public GetSchemeCardsoftheotherPlayersMessage() { this.messagecodex = 44; }

    @Override
    public void performAction(ClientHandlerInterface clientHandler, SocketServerListener listener) throws RemoteException {
        List list = clientHandler.getSchemeCardsoftheotherPlayers(getClientName());
