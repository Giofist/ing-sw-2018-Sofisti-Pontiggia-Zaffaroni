...
public class GetPrivateGoalCardNameMessage extends ClientMessage {

    public GetPrivateGoalCardNameMessage() { this.messagecodex = 44; }

    @Override
    public void performAction(ClientHandlerInterface clientHandler, SocketServerListener listener) throws RemoteException{
        String answer = clientHandler.getPrivateGoalCardname(getClientName());
